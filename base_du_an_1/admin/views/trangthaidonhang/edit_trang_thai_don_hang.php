...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cập nhật trạng thái | NN Shop</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Quản lí trạng thái </h4>
                                            ...
                                            <div class="row">                                              
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập tên trạng thái" name="ten_trang_thai" value="<?= $trangThaiDonHang['ten_trang_thai'] ?? '' ?> " >
