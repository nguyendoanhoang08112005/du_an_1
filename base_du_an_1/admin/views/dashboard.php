                        ...
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-md-6" style="width: 208px;">
                                        <!-- card -->
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive table-card">
                                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                        ...
                                                        <?php foreach( $khachHangThanThiet  as $index =>   $khachHangThanThiets) : ?>
                                                        <tr>
                                                            <td class="fw-medium">
                                                                <?= $index +1 ?>
                                                            </td>
                                                            <td>
                                                                <?= $khachHangThanThiets['nguoi_dung_id']?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php 
                                                                $hinhanh="../uploads/".$khachHangThanThiets['anh_dai_dien'];
                                                               
                                                                if (is_file($hinhanh)) {
                                                                    $hinh="<img src='".$hinhanh."' height ='50'>";
                                                                }
                                                                else{
                                                                    $hinh = "no photo";
                                                                }?>
                                                                <?= $hinh?>
                                                                <?= $khachHangThanThiets['ho_ten']?>
                                                           
                                                            </td>
                                                            <td>
                                                                <?= $khachHangThanThiets['tong_don_hang']?>
                                                            </td>
                                                            <td>
                                                                <?= $khachHangThanThiets['tong_tien']?>
                                                            </td>
                                                            <td>
                                                                
                                                                <span class="badge bg-success"><?= $khachHangThanThiets['trang_thai']?></span>
                                                            </td>
