                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <?php if(isset($_SESSION['erorr']['hinh_anh'])) {?>
                                                            <p class="text-danger"><?= $_SESSION['erorr']['hinh_anh'] ?></p>
                                                        <?php }?>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="emailidInput" class="form-label">Album ảnh sản phẩm </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <span class="text-danger">
                                                            <?= !empty($_SESSION['errors']['gia-nhap']) ? $_SESSION['errors']['gia-nhap'] : '' ?>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea type="name" name="mo_ta"  rows="6" cols="90" placeholder="Nhập mô tả"  ></textarea><br><br>
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" name="trang_thai">
                                                            ...
                                                            <option value="2">Dừng hàng</option>
                                                        </select>
                                                        <span class="text-danger">
