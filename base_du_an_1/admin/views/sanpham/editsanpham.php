                                    ...
                                    <div class="live-preview">
                                        <form action="?act=sua-san-pham" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Tên sản phẩm </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                    <label for="emailidInput" class="form-label">Ảnh sản phẩm</label>
                                                            <input type="file" class="form-control" name="hinh_anh">
                                                            <br> <img src="<?= BASE_URL . $SanPham['hinh_anh'] ?>" style=" width: 120px;margin-left: 40%;height: 120px;" alt="">
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Giá nhập</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Giá bán </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Giá khuyến mãi </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Ngày nhập </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Số lượng </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Trạng thái </label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Mo ta </label> <br>
                                                        <textarea type="name" name="mo_ta" value="<?= $lienHe['mo_ta'] ?? ''?>" rows="6" cols="70" placeholder="Nhập mô tả"  ><?= $SanPham['mo_ta'] ?></textarea><br><br>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="FormidInput" class="form-label">Danh muc </label>
                                                        <select class="form-select" name="danh_muc_id" >
                                                            <?php foreach($listDanhMuc  as $danhmuc): ?>
                                                                <option <?php $danhmuc['id'] == $SanPham['id'] ? 'selected' : '' ?> value="<?= $danhmuc['id'] ?>">
