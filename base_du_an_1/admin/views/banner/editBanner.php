                                   ...
                                   <div class="h-100">
                                        <div class="card">
                                             <div class="card-header align-items-center d-flex">
                                                  <h4 class="card-title mb-0 flex-grow-1">sửa banner</h4>
                                             </div><!-- end card header -->
                                             <div class="card-body">
                                                       ...
                                                       <form action="?act=sua-banner" method="POST"
                                                            ...
                                                            <div class="row">
                                                                 <div class="col-md-6">
                                                                      <div class="mb-3">
                                                                           <label for="citynameInput"
                                                                                class="form-label">Tên Banner</label>
                                                                           <input type="text" class="form-control"
                                                                                placeholder="nhập tên banner"
                                                                                name="tieu_de"
                                                                                value="<?= $Banner['tieu_de'] ?>">
                                                                 ...
                                                                 <div class="col-md-6">
                                                                      ...
                                                                      <img src="<?= BASE_URL . $Banner['hinh_anh'] ?>" style=" width: 300px;height: 120px;" alt="">
                                                                      </div>
                                                                 </div>
                                                                 <!--end col-->
                                                                 <div class="col-md-6">
                                                                      <div class="mb-3">
                                                                           ...
                                                                           <select class="form-select"
                                                                                ...
                                                                                <option value="1"
                                                                                     <?= $Banner['trang_thai'] == 1 ? 'selected' : '' ?>>hiển thị
                                                                                </option>
                                                                                <option value="2"
                                                                                     <?= $Banner['trang_thai'] == 2 ? 'selected' : '' ?>>không hiển thị
                                                                                </option>
                                                                           </select>
                                                                           <span class="text-danger">
