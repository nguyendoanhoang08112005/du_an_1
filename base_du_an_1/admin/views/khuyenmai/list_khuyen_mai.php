...
<head>
    ...
    <meta charset="utf-8" />
    <title>Khuyến mãi | NN Shop</title>
                                            ...
                                            <table class="table table-striped table-nowrap align-middle mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $khuyenMai['trang_thai']?></td>
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                <a href="?act=show-khuyen-mai&khuyen_mai_id=<?= $khuyenMai['id'] ?>;"><i class="ri-eye-fill"></i></a>
                                                                <a href="?act=form-sua-khuyen-mai&khuyen_mai_id=<?= $khuyenMai['id'] ?>;" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                <form action="?act=xoa-khuyen-mai" method="POST" onsubmit="return confirm('Bạn có đồng ý không')">
