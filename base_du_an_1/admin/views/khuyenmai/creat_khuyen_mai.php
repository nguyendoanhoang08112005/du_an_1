...
<head>
    ...
    <meta charset="utf-8" />
    <title>Thêm khuyến mãi | NN Shop</title>
                                            ...
                                            <div class="row">                                              
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập giá trị" name="gia_tri">
                                                        <span class="text-danger">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <textarea name="mo_ta" rows="6" cols="50" placeholder="Nhập mô tả" ></textarea><br><br>
                                                        <span class="text-danger">
