...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cập nhật khuyến mãi | NN Shop</title>
                                            ...
                                            <div class="row">                                              
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập giá trị" name="gia_tri" value="<?= $khuyenMai['gia_tri']?>">
                                                        <span class="text-danger">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhập Ngày bắt đầu" name="ngay_bat_dau" value="<?= $khuyenMai['ngay_bat_dau']?>">
                                                        <span class="text-danger">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <input type="date" class="form-control" placeholder="Nhập Ngày kết thúc" name="ngay_ket_thuc" value="<?= $khuyenMai['ngay_ket_thuc']?>">
                                                        <span class="text-danger">
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <textarea name="mo_ta" rows="6" cols="50" placeholder="Nhập mô tả" ><?= $khuyenMai['mo_ta']?></textarea><br><br>
                                                        <span class="text-danger">
