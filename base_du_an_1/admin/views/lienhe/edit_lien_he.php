...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cập nhật liên hệ | NN Shop</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Quản lí liên hệ</h4>
                                            ...
                                            <div class="row">                                              
                                                <div class="col-md-12">
                                                    <div class="mb-12">
                                                        ...
                                                        <input type="email" class="form-control"  name="email" value="<?= $lienHe['email'] ?? ''?>">
                                                    ...
                                                    <div class="mb-12">
                                                        ...
                                                        <input type="text" class="form-control"  name="so_dien_thoai" value="<?= $lienHe['so_dien_thoai'] ?? ''?>">
                                                        <span class="text-danger">
                                                    ...
                                                    <div class="mb-12">
                                                        ...
                                                        <input type="text" class="form-control"  name="dia_chi" value="<?= $lienHe['dia_chi'] ?? ''?>">
                                                        <span class="text-danger">
                                                            <?= !empty($_SESSION['errors']['dia_chi']) ? $_SESSION['errors']['dia_chi'] : '' ?>
                                                        </span> <br> 
                                                    </div>
                                                    <div class="mb-12">
                                                        <label for="citynameInput" class="form-label">Nội dụng</label> <br>
                                                        <textarea type="name" name="noi_dung"  rows="6" cols="50" placeholder="Nhập nội dung" ><?= $lienHe['noi_dung'] ?? ''?></textarea><br><br>
                                                    </div>
                                                </div>
                                                <!--end col-->
