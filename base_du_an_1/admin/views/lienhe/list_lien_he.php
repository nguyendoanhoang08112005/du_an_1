                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href="?act=form-them-lien-he" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Thêm Liên hệ</a>
                                </div><!-- end card header -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hstack gap-3 flex-wrap">
                                                                ...
                                                                <form action="?act=xoa-lien-he" method="POST" onsubmit="return confirm('Bạn có đồng ý không')">
