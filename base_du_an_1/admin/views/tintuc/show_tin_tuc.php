...
<head>
    ...
    <meta charset="utf-8" />
    <title>Show tin tức | NN Shop</title>
                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Show tin tức</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="?act=show-tin-tuc" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?= $tinTuc['id']?>">
                                            <div class="row">                                              
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="citynameInput" class="form-label">Tiêu đề bài viết</label>
                                                        <input type="text" disabled class="form-control" placeholder="Nhập tiêu đề" name="tieu_de_bai_viet" value="<?= $tinTuc['tieu_de_bai_viet'] ?? ''?>">
                                                        ...
                                                        <input disabled type="file" class="form-control" name="hinh_anh" >
                                                        <?php 
                                                ...
                                                <textarea type="name" name="noi_dung" disabled rows="6" cols="90" placeholder="Nhập nội dung"  ><?= $tinTuc['noi_dung'] ?? ''?></textarea><br><br>
                                                <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label for="citynameInput" class="form-label">Ngày đăng</label>
                                                        <input type="date" disabled class="form-control" name="ngay_dang" value="<?= $tinTuc['ngay_dang'] ?? ''?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <a href="?act=tin-tucs" class="btn btn-primary">Trở lại</a>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
