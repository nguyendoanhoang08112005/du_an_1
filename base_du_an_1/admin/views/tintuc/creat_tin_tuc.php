                                            ...
                                            <div class="row">                                              
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập tiêu đề" name="tieu_de_bai_viet">
                                                        ...
                                                        <textarea name="noi_dung" rows="6" cols="50" placeholder="Nhập nội dung" ></textarea><br><br>
                                                        <span class="text-danger">
