                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="?act=show-tin-tuc&tin_tuc_id=<?= $tinTuc['id'] ?>;"><i class="ri-eye-fill"></i></a>
                                                                <a href="?act=form-sua-tin-tuc&tin_tuc_id=<?= $tinTuc['id'] ?>;" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                <form action="?act=xoa-tin-tuc" method="POST" onsubmit="return confirm('Bạn có đồng ý không')">
